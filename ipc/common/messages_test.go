...
func TestMessageBlockchainProcessBuiltinFunctionResponse_IsConsistentlySerializable(t *testing.T) {
	...
	message := common.NewMessageBlockchainProcessBuiltinFunctionResponse(vmOutput, nil)
	requireSerializationConsistency(t, message, &common.MessageBlockchainProcessBuiltinFunctionResponse{})
}
