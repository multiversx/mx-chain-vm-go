...
func (_m *MockBlockchainContext) CurrentRandomSeed() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for CurrentRandomSeed")
	}
...
func (_m *MockBlockchainContext) CurrentRound() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for CurrentRound")
	}
...
func (_m *MockBlockchainContext) CurrentTimeStamp() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for CurrentTimeStamp")
	}
...
func (_m *MockBlockchainContext) CurrentTimeStampMs() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for CurrentTimeStampMs")
	}
...
func (_m *MockBlockchainContext) EpochStartBlockNonce() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for EpochStartBlockNonce")
	}
...
func (_m *MockBlockchainContext) EpochStartBlockRound() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for EpochStartBlockRound")
	}
...
func (_m *MockBlockchainContext) EpochStartBlockTimeStampMs() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for EpochStartBlockTimeStampMs")
	}
...
func (_m *MockBlockchainContext) ExecuteSmartContractCallOnOtherVM(input *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ExecuteSmartContractCallOnOtherVM")
	}
...
func (_m *MockBlockchainContext) GetBalanceBigInt(addr []byte) *big.Int {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetBalanceBigInt")
	}
...
func (_m *MockBlockchainContext) GetCompiledCode(codeHash []byte) (bool, []byte) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCompiledCode")
	}
...
func (_m *MockBlockchainContext) GetESDTToken(address []byte, tokenID []byte, nonce uint64) (*esdt.ESDigitalToken, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetESDTToken")
	}
...
func (_m *MockBlockchainContext) GetOwnerAddress() ([]byte, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetOwnerAddress")
	}
...
func (_m *MockBlockchainContext) GetShardOfAddress(addr []byte) uint32 {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetShardOfAddress")
	}
...
func (_m *MockBlockchainContext) GetStateRootHash() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetStateRootHash")
	}
...
func (_m *MockBlockchainContext) IsLimitedTransfer(tokenID []byte) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsLimitedTransfer")
	}
...
func (_m *MockBlockchainContext) IsPayable(sndAddress []byte, rcvAddress []byte) (bool, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsPayable")
	}
...
func (_m *MockBlockchainContext) IsSmartContract(addr []byte) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsSmartContract")
	}
...
func (_m *MockBlockchainContext) LastEpoch() uint32 {
	...
	if len(ret) == 0 {
		panic("no return value specified for LastEpoch")
	}
...
func (_m *MockBlockchainContext) LastNonce() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for LastNonce")
	}
...
func (_m *MockBlockchainContext) LastRandomSeed() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for LastRandomSeed")
	}
...
func (_m *MockBlockchainContext) LastRound() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for LastRound")
	}
...
func (_m *MockBlockchainContext) LastTimeStamp() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for LastTimeStamp")
	}
...
func (_m *MockBlockchainContext) LastTimeStampMs() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for LastTimeStampMs")
	}
...
func (_m *MockBlockchainContext) ProcessBuiltInFunction(input *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ProcessBuiltInFunction")
	}
...
func (_m *MockBlockchainContext) RoundTime() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for RoundTime")
	}
