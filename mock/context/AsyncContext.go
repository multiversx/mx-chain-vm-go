...
func (_m *MockAsyncContext) CompleteChildConditional(isChildComplete bool, callID []byte, gasToAccumulate uint64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CompleteChildConditional")
	}
...
func (_m *MockAsyncContext) DeleteFromCallID(address []byte) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteFromCallID")
	}
...
func (_m *MockAsyncContext) ExecuteSyncCallbackAndFinishOutput(asyncCall *vmhost.AsyncCall, vmOutput *vmcommon.VMOutput, destinationCallInput *vmcommon.ContractCallInput, gasAccumulated uint64, err error) (bool, *vmcommon.VMOutput) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ExecuteSyncCallbackAndFinishOutput")
	}
...
func (_m *MockAsyncContext) GetAsyncCallByCallID(callID []byte) vmhost.AsyncCallLocation {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAsyncCallByCallID")
	}
...
func (_m *MockAsyncContext) GetCallGroup(groupID string) (*vmhost.AsyncCallGroup, bool) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCallGroup")
	}
...
func (_m *MockAsyncContext) GetCallID() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCallID")
	}
...
func (_m *MockAsyncContext) GetCallbackAsyncInitiatorCallID() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCallbackAsyncInitiatorCallID")
	}
...
func (_m *MockAsyncContext) GetCallbackClosure() ([]byte, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCallbackClosure")
	}
...
func (_m *MockAsyncContext) GetCallerAddress() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCallerAddress")
	}
...
func (_m *MockAsyncContext) GetCallerCallID() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCallerCallID")
	}
...
func (_m *MockAsyncContext) GetGasAccumulated() uint64 {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetGasAccumulated")
	}
...
func (_m *MockAsyncContext) GetParentAddress() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetParentAddress")
	}
...
func (_m *MockAsyncContext) GetReturnData() []byte {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetReturnData")
	}
...
func (_m *MockAsyncContext) HasLegacyGroup() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for HasLegacyGroup")
	}
...
func (_m *MockAsyncContext) HasPendingCallGroups() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for HasPendingCallGroups")
	}
...
func (_m *MockAsyncContext) InitStateFromInput(input *vmcommon.ContractCallInput) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for InitStateFromInput")
	}
...
func (_m *MockAsyncContext) IsCrossShard() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsCrossShard")
	}
...
func (_m *MockAsyncContext) LoadParentContext() error {
	...
	if len(ret) == 0 {
		panic("no return value specified for LoadParentContext")
	}
...
func (_m *MockAsyncContext) LoadParentContextFromStackOrStorage() (vmhost.AsyncContext, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for LoadParentContextFromStackOrStorage")
	}
...
func (_m *MockAsyncContext) NotifyChildIsComplete(callID []byte, gasToAccumulate uint64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for NotifyChildIsComplete")
	}
...
func (_m *MockAsyncContext) RegisterAsyncCall(groupID string, call *vmhost.AsyncCall) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RegisterAsyncCall")
	}
...
func (_m *MockAsyncContext) RegisterLegacyAsyncCall(address []byte, data []byte, value []byte) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RegisterLegacyAsyncCall")
	}
...
func (_m *MockAsyncContext) SetContextCallback(callbackName string, data []byte, gas uint64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SetContextCallback")
	}
...
func (_m *MockAsyncContext) UpdateCurrentAsyncCallStatus(address []byte, callID []byte, vmInput *vmcommon.VMInput) (*vmhost.AsyncCall, bool, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateCurrentAsyncCallStatus")
	}
