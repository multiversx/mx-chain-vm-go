...
func (host *VMHostMock) ExecuteOnDestContext(input *vmcommon.ContractCallInput) (*vmcommon.VMOutput, error, bool) {
	if host.Err != nil {
		return nil, host.Err, true
	}
	host.StoreInput(input)
	return host.GetNextVMOutput(), nil, true
}
