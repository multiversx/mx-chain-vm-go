...
func TestNewManagedTypes(t *testing.T) {
	...
	require.NotNil(t, managedTypesContext.managedTypesValues.manBufValues)
	...
	require.Equal(t, 0, len(managedTypesContext.managedTypesValues.manBufValues))
...
func TestManagedTypesContext_InitPushPopState(t *testing.T) {
	...
	manBuf, err = managedTypesContext.GetBytesForThisManagedBuffer(manBufHandle1)
	require.Nil(t, manBuf)
