...
func (validator *wasmValidator) verifyMemoryDeclaration(instance executorinterface.InstanceHandler) error {
...
func (validator *wasmValidator) verifyFunctions(instance executorinterface.InstanceHandler) error {
...
func (validator *wasmValidator) verifyProtectedFunctions(instance executorinterface.InstanceHandler) error {
	for _, functionName := range instance.GetFunctionNames() {
