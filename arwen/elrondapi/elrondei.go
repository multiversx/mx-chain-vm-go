...
// extern int32_t transferESDT(void *context, int32_t dstOffset, int32_t tokenIdOffset, int32_t tokenIdLen, int32_t valueOffset, int64_t gasLimit, int32_t dataOffset, int32_t length);
