...
type SerializableAsyncContext struct {
	...
	OriginalCallerAddress        []byte                               `protobuf:"bytes,15,opt,name=OriginalCallerAddress,proto3" json:"OriginalCallerAddress,omitempty"`
}
...
func (m *SerializableAsyncContext) GetOriginalCallerAddress() []byte {
	if m != nil {
		return m.OriginalCallerAddress
	}
	return nil
}
...
var fileDescriptor_83b2a03067ffcb1d = []byte{
	...
	,
}
...
func (this *SerializableAsyncContext) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.OriginalCallerAddress, that1.OriginalCallerAddress) {
		return false
	}
	return true
}
...
func (this *SerializableAsyncContext) GoString() string {
	...
	s = append(s, "OriginalCallerAddress: "+fmt.Sprintf("%#v", this.OriginalCallerAddress)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SerializableAsyncContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.OriginalCallerAddress) > 0 {
		i -= len(m.OriginalCallerAddress)
		copy(dAtA[i:], m.OriginalCallerAddress)
		i = encodeVarintAsync(dAtA, i, uint64(len(m.OriginalCallerAddress)))
		i--
		dAtA[i] = 0x7a
	}
...
func (this *SerializableAsyncContext) String() string {
	...
	s := strings.Join([]string{`&SerializableAsyncContext{`,
		...
		`OriginalCallerAddress:` + fmt.Sprintf("%v", this.OriginalCallerAddress) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SerializableAsyncContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OriginalCallerAddress", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OriginalCallerAddress = append(m.OriginalCallerAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.OriginalCallerAddress == nil {
				m.OriginalCallerAddress = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
