...
func createTestVMHooks() (*VMHooksImpl, *context.MockVMHost, *context.MockRuntimeContext, *context.MockMeteringContext, *context.MockOutputContext, *context.MockStorageContext) {
	host := &context.MockVMHost{}
	runtime := &context.MockRuntimeContext{}
	metering := &context.MockMeteringContext{}
	output := &context.MockOutputContext{}
