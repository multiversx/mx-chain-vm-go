...
func createTestHostWithMocks() (*vmHost, *mockery.MockRuntimeContext, *mockery.MockAsyncContext) {
	runtimeMock := &mockery.MockRuntimeContext{}
	asyncMock := &mockery.MockAsyncContext{}
	host := &vmHost{
