...
func (host *vmHost) ExecuteOnDestContext(input *vmcommon.ContractCallInput) (vmOutput *vmcommon.VMOutput, isChildComplete bool, err error) {
	...
	if host.IsBuiltinFunctionName(input.Function) {
		vmOutput, isChildComplete, err = host.executeBuiltinOnDestContext(input)
		return
	}
...
func (host *vmHost) executeBuiltinOnDestContext(input *vmcommon.ContractCallInput) (vmOutput *vmcommon.VMOutput, isChildComplete bool, err error) {
