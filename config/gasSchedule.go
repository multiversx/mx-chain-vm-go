...
func CreateGasConfig(gasMap GasScheduleMap) (*GasCost, error) {
	...
	err = mapstructure.Decode(gasMap["OpcodeCostWasmer2"], opcodeCostWasmer2)
	if err != nil {
		return nil, err
	}

	err = checkForZeroUint64Fields(*opcodeCostWasmer2)
	if err != nil {
		return nil, err
	}
	...
	gasCost := &GasCost{
		...
		OpcodeCostWasmer2:    opcodeCostWasmer2,
	}
...
func FillGasMap(gasMap GasScheduleMap, value, asyncCallbackGasLock uint64) GasScheduleMap {
	...
	gasMap["OpcodeCostWasmer2"] = FillGasMap_OpcodeCostWasmer2(value)
...
func FillGasMap_OpcodeCostWasmer2(value uint64) map[string]uint64 {
	gasMap := make(map[string]uint64)
	gasMap["Unreachable"] = value
	gasMap["Nop"] = value
	gasMap["Block"] = value
