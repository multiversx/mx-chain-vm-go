...
func populateCgoFunctionPointers() *cWasmerVmHookPointers {
	return &cWasmerVmHookPointers{
		get_gas_left_func_ptr: funcPointer(w2_getGasLeft),
		get_sc_address_func_ptr: funcPointer(w2_getSCAddress),
		get_owner_address_func_ptr: funcPointer(w2_getOwnerAddress),
		get_shard_of_address_func_ptr: funcPointer(w2_getShardOfAddress),
		is_smart_contract_func_ptr: funcPointer(w2_isSmartContract),
		signal_error_func_ptr: funcPointer(w2_signalError),
		get_external_balance_func_ptr: funcPointer(w2_getExternalBalance),
		get_block_hash_func_ptr: funcPointer(w2_getBlockHash),
		get_esdt_balance_func_ptr: funcPointer(w2_getESDTBalance),
		get_esdt_nft_name_length_func_ptr: funcPointer(w2_getESDTNFTNameLength),
		get_esdt_nft_attribute_length_func_ptr: funcPointer(w2_getESDTNFTAttributeLength),
		get_esdt_nft_uri_length_func_ptr: funcPointer(w2_getESDTNFTURILength),
		get_esdt_token_data_func_ptr: funcPointer(w2_getESDTTokenData),
		get_esdt_local_roles_func_ptr: funcPointer(w2_getESDTLocalRoles),
		validate_token_identifier_func_ptr: funcPointer(w2_validateTokenIdentifier),
		transfer_value_func_ptr: funcPointer(w2_transferValue),
		transfer_value_execute_func_ptr: funcPointer(w2_transferValueExecute),
		transfer_esdt_execute_func_ptr: funcPointer(w2_transferESDTExecute),
		transfer_esdt_nft_execute_func_ptr: funcPointer(w2_transferESDTNFTExecute),
		multi_transfer_esdt_nft_execute_func_ptr: funcPointer(w2_multiTransferESDTNFTExecute),
		create_async_call_func_ptr: funcPointer(w2_createAsyncCall),
		set_async_context_callback_func_ptr: funcPointer(w2_setAsyncContextCallback),
		upgrade_contract_func_ptr: funcPointer(w2_upgradeContract),
		upgrade_from_source_contract_func_ptr: funcPointer(w2_upgradeFromSourceContract),
		delete_contract_func_ptr: funcPointer(w2_deleteContract),
		async_call_func_ptr: funcPointer(w2_asyncCall),
		get_argument_length_func_ptr: funcPointer(w2_getArgumentLength),
		get_argument_func_ptr: funcPointer(w2_getArgument),
		get_function_func_ptr: funcPointer(w2_getFunction),
		get_num_arguments_func_ptr: funcPointer(w2_getNumArguments),
		storage_store_func_ptr: funcPointer(w2_storageStore),
		storage_load_length_func_ptr: funcPointer(w2_storageLoadLength),
		storage_load_from_address_func_ptr: funcPointer(w2_storageLoadFromAddress),
		storage_load_func_ptr: funcPointer(w2_storageLoad),
		set_storage_lock_func_ptr: funcPointer(w2_setStorageLock),
		get_storage_lock_func_ptr: funcPointer(w2_getStorageLock),
		is_storage_locked_func_ptr: funcPointer(w2_isStorageLocked),
		clear_storage_lock_func_ptr: funcPointer(w2_clearStorageLock),
		get_caller_func_ptr: funcPointer(w2_getCaller),
		check_no_payment_func_ptr: funcPointer(w2_checkNoPayment),
		get_call_value_func_ptr: funcPointer(w2_getCallValue),
		get_esdt_value_func_ptr: funcPointer(w2_getESDTValue),
		get_esdt_value_by_index_func_ptr: funcPointer(w2_getESDTValueByIndex),
		get_esdt_token_name_func_ptr: funcPointer(w2_getESDTTokenName),
		get_esdt_token_name_by_index_func_ptr: funcPointer(w2_getESDTTokenNameByIndex),
		get_esdt_token_nonce_func_ptr: funcPointer(w2_getESDTTokenNonce),
		get_esdt_token_nonce_by_index_func_ptr: funcPointer(w2_getESDTTokenNonceByIndex),
		get_current_esdt_nft_nonce_func_ptr: funcPointer(w2_getCurrentESDTNFTNonce),
		get_esdt_token_type_func_ptr: funcPointer(w2_getESDTTokenType),
		get_esdt_token_type_by_index_func_ptr: funcPointer(w2_getESDTTokenTypeByIndex),
		get_num_esdt_transfers_func_ptr: funcPointer(w2_getNumESDTTransfers),
		get_call_value_token_name_func_ptr: funcPointer(w2_getCallValueTokenName),
		get_call_value_token_name_by_index_func_ptr: funcPointer(w2_getCallValueTokenNameByIndex),
		write_log_func_ptr: funcPointer(w2_writeLog),
		write_event_log_func_ptr: funcPointer(w2_writeEventLog),
		get_block_timestamp_func_ptr: funcPointer(w2_getBlockTimestamp),
		get_block_nonce_func_ptr: funcPointer(w2_getBlockNonce),
		get_block_round_func_ptr: funcPointer(w2_getBlockRound),
		get_block_epoch_func_ptr: funcPointer(w2_getBlockEpoch),
		get_block_random_seed_func_ptr: funcPointer(w2_getBlockRandomSeed),
		get_state_root_hash_func_ptr: funcPointer(w2_getStateRootHash),
		get_prev_block_timestamp_func_ptr: funcPointer(w2_getPrevBlockTimestamp),
		get_prev_block_nonce_func_ptr: funcPointer(w2_getPrevBlockNonce),
		get_prev_block_round_func_ptr: funcPointer(w2_getPrevBlockRound),
		get_prev_block_epoch_func_ptr: funcPointer(w2_getPrevBlockEpoch),
		get_prev_block_random_seed_func_ptr: funcPointer(w2_getPrevBlockRandomSeed),
		finish_func_ptr: funcPointer(w2_finish),
		execute_on_same_context_func_ptr: funcPointer(w2_executeOnSameContext),
		execute_on_dest_context_func_ptr: funcPointer(w2_executeOnDestContext),
		execute_read_only_func_ptr: funcPointer(w2_executeReadOnly),
		create_contract_func_ptr: funcPointer(w2_createContract),
		deploy_from_source_contract_func_ptr: funcPointer(w2_deployFromSourceContract),
		get_num_return_data_func_ptr: funcPointer(w2_getNumReturnData),
		get_return_data_size_func_ptr: funcPointer(w2_getReturnDataSize),
		get_return_data_func_ptr: funcPointer(w2_getReturnData),
		clean_return_data_func_ptr: funcPointer(w2_cleanReturnData),
		delete_from_return_data_func_ptr: funcPointer(w2_deleteFromReturnData),
		get_original_tx_hash_func_ptr: funcPointer(w2_getOriginalTxHash),
		get_current_tx_hash_func_ptr: funcPointer(w2_getCurrentTxHash),
		get_prev_tx_hash_func_ptr: funcPointer(w2_getPrevTxHash),
		managed_sc_address_func_ptr: funcPointer(w2_managedSCAddress),
		managed_owner_address_func_ptr: funcPointer(w2_managedOwnerAddress),
		managed_caller_func_ptr: funcPointer(w2_managedCaller),
		managed_signal_error_func_ptr: funcPointer(w2_managedSignalError),
		managed_write_log_func_ptr: funcPointer(w2_managedWriteLog),
		managed_get_original_tx_hash_func_ptr: funcPointer(w2_managedGetOriginalTxHash),
		managed_get_state_root_hash_func_ptr: funcPointer(w2_managedGetStateRootHash),
		managed_get_block_random_seed_func_ptr: funcPointer(w2_managedGetBlockRandomSeed),
		managed_get_prev_block_random_seed_func_ptr: funcPointer(w2_managedGetPrevBlockRandomSeed),
		managed_get_return_data_func_ptr: funcPointer(w2_managedGetReturnData),
		managed_get_multi_esdt_call_value_func_ptr: funcPointer(w2_managedGetMultiESDTCallValue),
		managed_get_esdt_balance_func_ptr: funcPointer(w2_managedGetESDTBalance),
		managed_get_esdt_token_data_func_ptr: funcPointer(w2_managedGetESDTTokenData),
		managed_async_call_func_ptr: funcPointer(w2_managedAsyncCall),
		managed_create_async_call_func_ptr: funcPointer(w2_managedCreateAsyncCall),
		managed_get_callback_closure_func_ptr: funcPointer(w2_managedGetCallbackClosure),
		managed_upgrade_from_source_contract_func_ptr: funcPointer(w2_managedUpgradeFromSourceContract),
		managed_upgrade_contract_func_ptr: funcPointer(w2_managedUpgradeContract),
		managed_delete_contract_func_ptr: funcPointer(w2_managedDeleteContract),
		managed_deploy_from_source_contract_func_ptr: funcPointer(w2_managedDeployFromSourceContract),
		managed_create_contract_func_ptr: funcPointer(w2_managedCreateContract),
		managed_execute_read_only_func_ptr: funcPointer(w2_managedExecuteReadOnly),
		managed_execute_on_same_context_func_ptr: funcPointer(w2_managedExecuteOnSameContext),
		managed_execute_on_dest_context_func_ptr: funcPointer(w2_managedExecuteOnDestContext),
		managed_multi_transfer_esdt_nft_execute_func_ptr: funcPointer(w2_managedMultiTransferESDTNFTExecute),
		managed_transfer_value_execute_func_ptr: funcPointer(w2_managedTransferValueExecute),
		managed_is_esdt_frozen_func_ptr: funcPointer(w2_managedIsESDTFrozen),
		managed_is_esdt_limited_transfer_func_ptr: funcPointer(w2_managedIsESDTLimitedTransfer),
		managed_is_esdt_paused_func_ptr: funcPointer(w2_managedIsESDTPaused),
		managed_buffer_to_hex_func_ptr: funcPointer(w2_managedBufferToHex),
		big_float_new_from_parts_func_ptr: funcPointer(w2_bigFloatNewFromParts),
		big_float_new_from_frac_func_ptr: funcPointer(w2_bigFloatNewFromFrac),
		big_float_new_from_sci_func_ptr: funcPointer(w2_bigFloatNewFromSci),
		big_float_add_func_ptr: funcPointer(w2_bigFloatAdd),
		big_float_sub_func_ptr: funcPointer(w2_bigFloatSub),
		big_float_mul_func_ptr: funcPointer(w2_bigFloatMul),
		big_float_div_func_ptr: funcPointer(w2_bigFloatDiv),
		big_float_neg_func_ptr: funcPointer(w2_bigFloatNeg),
		big_float_clone_func_ptr: funcPointer(w2_bigFloatClone),
		big_float_cmp_func_ptr: funcPointer(w2_bigFloatCmp),
		big_float_abs_func_ptr: funcPointer(w2_bigFloatAbs),
		big_float_sign_func_ptr: funcPointer(w2_bigFloatSign),
		big_float_sqrt_func_ptr: funcPointer(w2_bigFloatSqrt),
		big_float_pow_func_ptr: funcPointer(w2_bigFloatPow),
		big_float_floor_func_ptr: funcPointer(w2_bigFloatFloor),
		big_float_ceil_func_ptr: funcPointer(w2_bigFloatCeil),
		big_float_truncate_func_ptr: funcPointer(w2_bigFloatTruncate),
		big_float_set_int64_func_ptr: funcPointer(w2_bigFloatSetInt64),
		big_float_is_int_func_ptr: funcPointer(w2_bigFloatIsInt),
		big_float_set_big_int_func_ptr: funcPointer(w2_bigFloatSetBigInt),
		big_float_get_const_pi_func_ptr: funcPointer(w2_bigFloatGetConstPi),
		big_float_get_const_e_func_ptr: funcPointer(w2_bigFloatGetConstE),
		big_int_get_unsigned_argument_func_ptr: funcPointer(w2_bigIntGetUnsignedArgument),
		big_int_get_signed_argument_func_ptr: funcPointer(w2_bigIntGetSignedArgument),
		big_int_storage_store_unsigned_func_ptr: funcPointer(w2_bigIntStorageStoreUnsigned),
		big_int_storage_load_unsigned_func_ptr: funcPointer(w2_bigIntStorageLoadUnsigned),
		big_int_get_call_value_func_ptr: funcPointer(w2_bigIntGetCallValue),
		big_int_get_esdt_call_value_func_ptr: funcPointer(w2_bigIntGetESDTCallValue),
		big_int_get_esdt_call_value_by_index_func_ptr: funcPointer(w2_bigIntGetESDTCallValueByIndex),
		big_int_get_external_balance_func_ptr: funcPointer(w2_bigIntGetExternalBalance),
		big_int_get_esdt_external_balance_func_ptr: funcPointer(w2_bigIntGetESDTExternalBalance),
		big_int_new_func_ptr: funcPointer(w2_bigIntNew),
		big_int_unsigned_byte_length_func_ptr: funcPointer(w2_bigIntUnsignedByteLength),
		big_int_signed_byte_length_func_ptr: funcPointer(w2_bigIntSignedByteLength),
		big_int_get_unsigned_bytes_func_ptr: funcPointer(w2_bigIntGetUnsignedBytes),
		big_int_get_signed_bytes_func_ptr: funcPointer(w2_bigIntGetSignedBytes),
		big_int_set_unsigned_bytes_func_ptr: funcPointer(w2_bigIntSetUnsignedBytes),
		big_int_set_signed_bytes_func_ptr: funcPointer(w2_bigIntSetSignedBytes),
		big_int_is_int64_func_ptr: funcPointer(w2_bigIntIsInt64),
		big_int_get_int64_func_ptr: funcPointer(w2_bigIntGetInt64),
		big_int_set_int64_func_ptr: funcPointer(w2_bigIntSetInt64),
		big_int_add_func_ptr: funcPointer(w2_bigIntAdd),
		big_int_sub_func_ptr: funcPointer(w2_bigIntSub),
		big_int_mul_func_ptr: funcPointer(w2_bigIntMul),
		big_int_tdiv_func_ptr: funcPointer(w2_bigIntTDiv),
		big_int_tmod_func_ptr: funcPointer(w2_bigIntTMod),
		big_int_ediv_func_ptr: funcPointer(w2_bigIntEDiv),
		big_int_emod_func_ptr: funcPointer(w2_bigIntEMod),
		big_int_sqrt_func_ptr: funcPointer(w2_bigIntSqrt),
		big_int_pow_func_ptr: funcPointer(w2_bigIntPow),
		big_int_log2_func_ptr: funcPointer(w2_bigIntLog2),
		big_int_abs_func_ptr: funcPointer(w2_bigIntAbs),
		big_int_neg_func_ptr: funcPointer(w2_bigIntNeg),
		big_int_sign_func_ptr: funcPointer(w2_bigIntSign),
		big_int_cmp_func_ptr: funcPointer(w2_bigIntCmp),
		big_int_not_func_ptr: funcPointer(w2_bigIntNot),
		big_int_and_func_ptr: funcPointer(w2_bigIntAnd),
		big_int_or_func_ptr: funcPointer(w2_bigIntOr),
		big_int_xor_func_ptr: funcPointer(w2_bigIntXor),
		big_int_shr_func_ptr: funcPointer(w2_bigIntShr),
		big_int_shl_func_ptr: funcPointer(w2_bigIntShl),
		big_int_finish_unsigned_func_ptr: funcPointer(w2_bigIntFinishUnsigned),
		big_int_finish_signed_func_ptr: funcPointer(w2_bigIntFinishSigned),
		big_int_to_string_func_ptr: funcPointer(w2_bigIntToString),
		mbuffer_new_func_ptr: funcPointer(w2_mBufferNew),
		mbuffer_new_from_bytes_func_ptr: funcPointer(w2_mBufferNewFromBytes),
		mbuffer_get_length_func_ptr: funcPointer(w2_mBufferGetLength),
		mbuffer_get_bytes_func_ptr: funcPointer(w2_mBufferGetBytes),
		mbuffer_get_byte_slice_func_ptr: funcPointer(w2_mBufferGetByteSlice),
		mbuffer_copy_byte_slice_func_ptr: funcPointer(w2_mBufferCopyByteSlice),
		mbuffer_eq_func_ptr: funcPointer(w2_mBufferEq),
		mbuffer_set_bytes_func_ptr: funcPointer(w2_mBufferSetBytes),
		mbuffer_set_byte_slice_func_ptr: funcPointer(w2_mBufferSetByteSlice),
		mbuffer_append_func_ptr: funcPointer(w2_mBufferAppend),
		mbuffer_append_bytes_func_ptr: funcPointer(w2_mBufferAppendBytes),
		mbuffer_to_big_int_unsigned_func_ptr: funcPointer(w2_mBufferToBigIntUnsigned),
		mbuffer_to_big_int_signed_func_ptr: funcPointer(w2_mBufferToBigIntSigned),
		mbuffer_from_big_int_unsigned_func_ptr: funcPointer(w2_mBufferFromBigIntUnsigned),
		mbuffer_from_big_int_signed_func_ptr: funcPointer(w2_mBufferFromBigIntSigned),
		mbuffer_to_big_float_func_ptr: funcPointer(w2_mBufferToBigFloat),
		mbuffer_from_big_float_func_ptr: funcPointer(w2_mBufferFromBigFloat),
		mbuffer_storage_store_func_ptr: funcPointer(w2_mBufferStorageStore),
		mbuffer_storage_load_func_ptr: funcPointer(w2_mBufferStorageLoad),
		mbuffer_storage_load_from_address_func_ptr: funcPointer(w2_mBufferStorageLoadFromAddress),
		mbuffer_get_argument_func_ptr: funcPointer(w2_mBufferGetArgument),
		mbuffer_finish_func_ptr: funcPointer(w2_mBufferFinish),
		mbuffer_set_random_func_ptr: funcPointer(w2_mBufferSetRandom),
		small_int_get_unsigned_argument_func_ptr: funcPointer(w2_smallIntGetUnsignedArgument),
		small_int_get_signed_argument_func_ptr: funcPointer(w2_smallIntGetSignedArgument),
		small_int_finish_unsigned_func_ptr: funcPointer(w2_smallIntFinishUnsigned),
		small_int_finish_signed_func_ptr: funcPointer(w2_smallIntFinishSigned),
		small_int_storage_store_unsigned_func_ptr: funcPointer(w2_smallIntStorageStoreUnsigned),
		small_int_storage_store_signed_func_ptr: funcPointer(w2_smallIntStorageStoreSigned),
		small_int_storage_load_unsigned_func_ptr: funcPointer(w2_smallIntStorageLoadUnsigned),
		small_int_storage_load_signed_func_ptr: funcPointer(w2_smallIntStorageLoadSigned),
		int64get_argument_func_ptr: funcPointer(w2_int64getArgument),
		int64finish_func_ptr: funcPointer(w2_int64finish),
		int64storage_store_func_ptr: funcPointer(w2_int64storageStore),
		int64storage_load_func_ptr: funcPointer(w2_int64storageLoad),
		sha256_func_ptr: funcPointer(w2_sha256),
		managed_sha256_func_ptr: funcPointer(w2_managedSha256),
		keccak256_func_ptr: funcPointer(w2_keccak256),
		managed_keccak256_func_ptr: funcPointer(w2_managedKeccak256),
		ripemd160_func_ptr: funcPointer(w2_ripemd160),
		managed_ripemd160_func_ptr: funcPointer(w2_managedRipemd160),
		verify_bls_func_ptr: funcPointer(w2_verifyBLS),
		managed_verify_bls_func_ptr: funcPointer(w2_managedVerifyBLS),
		verify_ed25519_func_ptr: funcPointer(w2_verifyEd25519),
		managed_verify_ed25519_func_ptr: funcPointer(w2_managedVerifyEd25519),
		verify_custom_secp256k1_func_ptr: funcPointer(w2_verifyCustomSecp256k1),
		managed_verify_custom_secp256k1_func_ptr: funcPointer(w2_managedVerifyCustomSecp256k1),
		verify_secp256k1_func_ptr: funcPointer(w2_verifySecp256k1),
		managed_verify_secp256k1_func_ptr: funcPointer(w2_managedVerifySecp256k1),
		encode_secp256k1_der_signature_func_ptr: funcPointer(w2_encodeSecp256k1DerSignature),
		managed_encode_secp256k1_der_signature_func_ptr: funcPointer(w2_managedEncodeSecp256k1DerSignature),
		add_ec_func_ptr: funcPointer(w2_addEC),
		double_ec_func_ptr: funcPointer(w2_doubleEC),
		is_on_curve_ec_func_ptr: funcPointer(w2_isOnCurveEC),
		scalar_base_mult_ec_func_ptr: funcPointer(w2_scalarBaseMultEC),
		managed_scalar_base_mult_ec_func_ptr: funcPointer(w2_managedScalarBaseMultEC),
		scalar_mult_ec_func_ptr: funcPointer(w2_scalarMultEC),
		managed_scalar_mult_ec_func_ptr: funcPointer(w2_managedScalarMultEC),
		marshal_ec_func_ptr: funcPointer(w2_marshalEC),
		managed_marshal_ec_func_ptr: funcPointer(w2_managedMarshalEC),
		marshal_compressed_ec_func_ptr: funcPointer(w2_marshalCompressedEC),
		managed_marshal_compressed_ec_func_ptr: funcPointer(w2_managedMarshalCompressedEC),
		unmarshal_ec_func_ptr: funcPointer(w2_unmarshalEC),
		managed_unmarshal_ec_func_ptr: funcPointer(w2_managedUnmarshalEC),
		unmarshal_compressed_ec_func_ptr: funcPointer(w2_unmarshalCompressedEC),
		managed_unmarshal_compressed_ec_func_ptr: funcPointer(w2_managedUnmarshalCompressedEC),
		generate_key_ec_func_ptr: funcPointer(w2_generateKeyEC),
		managed_generate_key_ec_func_ptr: funcPointer(w2_managedGenerateKeyEC),
		create_ec_func_ptr: funcPointer(w2_createEC),
		managed_create_ec_func_ptr: funcPointer(w2_managedCreateEC),
		get_curve_length_ec_func_ptr: funcPointer(w2_getCurveLengthEC),
		get_priv_key_byte_length_ec_func_ptr: funcPointer(w2_getPrivKeyByteLengthEC),
		elliptic_curve_get_values_func_ptr: funcPointer(w2_ellipticCurveGetValues),
	}
}
